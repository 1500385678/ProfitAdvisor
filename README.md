...
| Phase 1 - MVP Web App | ⏳ 规划中 (0/7 复选框) | W08 后移节点 **0916 周三已过 1 工作日(9/17 周四)** 由张勇拍板是否启动 |
...
| 域 | 数量 | 路径 | 护栏脚本 | 验证窗口 |
|----|------|------|----------|----------|
| **calculators** | 16 / 30+ (53.3%) | `content/calculators/` | `scripts/validate_calculators.py` | 180h+ 稳定 |
| **cases** | 13 / 400+ (3.25%) | `content/cases/` | `scripts/validate_cases.py` | 143h+ 稳定 |
| **knowledge** | 1 / 7 (14.3%) | `content/knowledge/` | `scripts/validate_knowledge.py` | 129h+ 稳定 |
...
每日 02:40 cron 自动生成 `巡检-盈利-YYYYMMDD.md` 到 `.Log/` 目录,索引从 2026-08-26 起。当前 17 个工作日连续巡检(含 9/13 周日 cron 未触发的占位补录)。
...
**主计划**:`盈利顾问开发架构与计划.md` · **最新巡检**:`.Log/巡检-盈利-20260917.md` · **9/13 补录**:`.Log/巡检-盈利-20260913.md` · **维护**:张勇
